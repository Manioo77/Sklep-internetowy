...
<table class="tabela">
    ...
    <?php 
    $all_users = mysqli_query($con, "select * from uzytkownicy order by id DESC ");
    ...
    <tbody>
        <tr>
            ...
            <td>
                <?php if($row['image'] !='') { ?>
                <img src="../upload-files/<?php echo $row['image']; ?>" width="70" height="50" alt="">
...
if(isset($_GET['delete_user'])) {
    $delete_user = mysqli_query($con, "delete from uzytkownicy where id='$_GET[delete_user]' ");
...
if(isset($_POST['deleteAll'])) {
    ...
    foreach($remove as $key) {
        $run_remove = mysqli_query($con, "delete from uzytkownicy where id='$key' ");
